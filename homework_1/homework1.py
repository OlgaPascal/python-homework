...
a = int(input("Enter result for day 1: "))
challenge = int(input("Enter challenge in km: "))
day = 1
each_next_day = a / 100 * 10
next_day_result = each_next_day
print(f"each next day {each_next_day}")
while next_day_result < challenge:
    next_day_result += each_next_day * day
    day += 1
    print(f"{next_day_result} day {day}")
